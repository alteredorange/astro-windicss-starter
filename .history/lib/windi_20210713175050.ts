...
getAllFiles().then(e => {
  ...
  //   outputCSS
  //     .reduce(
  //       (previousValue, currentValue) => { return previousValue.extend(currentValue) }
  //       // new NewStyleSheet()
